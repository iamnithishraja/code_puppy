...
export const Preview = memo(() => {
    ...
    return (
      <div
        ...
        style={{
          ...
          height: '100%',
          cursor: 'ew-resize',
          background: 'var(--puppy-elements-background-depth-4, rgba(0,0,0,.3))',
          display: 'flex',
          alignItems: 'center',
        ...
        onMouseOver={(e) =>
          (e.currentTarget.style.background = 'var(--puppy-elements-background-depth-4, rgba(0,0,0,.3))')
        }
        onMouseOut={(e) =>
          (e.currentTarget.style.background = 'var(--puppy-elements-background-depth-3, rgba(0,0,0,.15))')
        }
  ...
  const GripIcon = () => (
    ...
    >
      <div
        style={{
          color: 'var(--puppy-elements-textSecondary, rgba(0,0,0,0.5))',
          fontSize: '10px',
          lineHeight: '5px',
          userSelect: 'none',
          marginLeft: '1px',
  ...
  return (
    ...
    >
      ...
      <div className="bg-puppy-elements-background-depth-2 p-2 flex items-center gap-2">
        <div className="flex items-center gap-2">
          <IconButton icon="i-ph:arrow-clockwise" onClick={reloadPreview} />
          <IconButton
            icon="i-ph:selection"
            onClick={() => setIsSelectionMode(!isSelectionMode)}
            className={isSelectionMode ? 'bg-puppy-elements-background-depth-3' : ''}
          />
        </div>

        <div className="flex-grow flex items-center gap-1 bg-puppy-elements-preview-addressBar-background border border-puppy-elements-borderColor text-puppy-elements-preview-addressBar-text rounded-full px-3 py-1 text-sm hover:bg-puppy-elements-preview-addressBar-backgroundHover hover:focus-within:bg-puppy-elements-preview-addressBar-backgroundActive focus-within:bg-puppy-elements-preview-addressBar-backgroundActive focus-within-border-puppy-elements-borderColorActive focus-within:text-puppy-elements-preview-addressBar-textActive">
          <input
            title="URL"
            ref={inputRef}
      ...
      <div className="flex-1 border-t border-puppy-elements-borderColor flex justify-center items-center overflow-auto">
        <div
          style={{
            width: isDeviceModeOn ? (showDeviceFrameInPreview ? '100%' : `${widthPercent}%`) : '100%',
            height: '100%',
            overflow: 'auto',
            background: 'var(--puppy-elements-background-depth-1)',
            position: 'relative',
            display: 'flex',
            justifyContent: 'center',
            alignItems: 'center',
            ...
            <>
              {isDeviceModeOn && showDeviceFrameInPreview ? (
                ...
                <iframe
                  ref={iframeRef}
                  title="preview"
                  className="border-none w-full h-full bg-puppy-elements-background-depth-1"
                  src={iframeUrl}
                  sandbox="allow-scripts allow-forms allow-popups allow-modals allow-storage-access-by-user-activation allow-same-origin"
                  allow="cross-origin-isolated"
                />
            ...
            <>
              ...
              <div
                style={{
                  ...
                  background: 'var(--puppy-elements-background-depth-3, rgba(0,0,0,0.7))',
                  color: 'var(--puppy-elements-textPrimary, white)',
                  padding: '2px 8px',
                  borderRadius: '4px',
                  fontSize: '12px',
                  pointerEvents: 'none',
