  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-puppy-elements-borderColor bg-puppy-elements-background-depth-1 text-puppy-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-puppy-elements-textSecondary', className)} {...props} />;
  },
);
