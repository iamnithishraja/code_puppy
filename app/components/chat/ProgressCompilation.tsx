      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-puppy-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-puppy-elements-item-backgroundAccent hover:bg-puppy-elements-artifacts-backgroundHover"
